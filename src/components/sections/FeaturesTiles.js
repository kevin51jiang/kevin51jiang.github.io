...
const FeaturesTiles = ({
  ...
  return (
    <section {...props} className={outerClasses} id="feature-tiles">
          ...
          <div className={tilesClasses}>
            ...
            >
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">Music Lover</h4>
                  <p className="m-0 text-sm">
                    New playlists every month! Here's my{" "}
                    <a href="https://open.spotify.com/user/jupjiaitclq6y7f98pc2opdjy?si=NuaNXESWQ5uiPytQ-LiKKg">
                      Spotify Profile
                    </a>
                    , where you see and silently judge my bad music taste.
                  </p>
                </div>
              </div>
            </div>
